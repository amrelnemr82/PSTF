...
| `runtime.txt` | Legacy Python version hint -- Streamlit Cloud now ignores this file; select Python 3.12 manually via "Advanced settings" when deploying instead |
...
4. Click **"Advanced settings"** and set the **Python version** dropdown to **3.12** (do this now -- it cannot be changed later without deleting and redeploying the app).
5. Click **Deploy**.
